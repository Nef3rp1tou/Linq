...
namespace Linq
{
    ...
    public static class SetOperations
    {
        ...
        public static IEnumerable<char> UnionOfQueryResults()
        {
            ...
            var productFilter = products.Select(p => p.ProductName[0]);
            var customerFilter = customers.Select(c => c.CompanyName[0]); //mistake in customer, used CompanyName instead of CustomerName

            return productFilter
                .Union(customerFilter)
                .Distinct();
        }
        ...
        public static IEnumerable<int> Intersect()
        {
            ...
            return numbersB.Intersect(numbersA);
        }
        ...
        public static IEnumerable<char> IntersectQueryResults()
        {
            ...
            var productFilter = products.Select(p => p.ProductName[0]);
            var customerFilter = customers.Select(c => c.CompanyName[0]);

            return productFilter
                .Intersect(customerFilter);
        }
