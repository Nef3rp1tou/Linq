...
namespace Linq
{
    ...
    public static class AggregationOperations
    {
        ...
        /// </summary>
        /// <returns>Count of odd numbers in the array.</returns>
        ...
        public static IEnumerable<(string customerId, int orderCount)> CustomersOrdersCount()
        {
            ...
            return customers.Select(c => (c.CustomerId, c.Orders.Count()));
        }
        ...
        public static double SeededAggregate()
        {
            ...
            return attemptedWithdrawals.Aggregate(startBalance,
                (balance, withdrawal) => balance >= withdrawal ? balance - withdrawal : balance);
        }
    }
}
